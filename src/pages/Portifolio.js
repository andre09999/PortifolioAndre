...
function Portifolio({color}) {
  return (
    <main id='portifolio' className='projetos-cont'>
        <h1 className={color}>Projetos</h1>
        ...
        <h2 className={color}>Projeto App de receita</h2>
        ...
        <h2 className={color}>Projeto Historia do android</h2>
        ...
        <h2 className={color}>Projeto Online store</h2>
        ...
        <h2 className={color}>Projeto Starwars</h2>
        ...
        <h2 className={color}>Projeto Trivia</h2>
        ...
        <h2 className={color}>Projeto Tryunfu</h2>
        ...
        <h2 className={color}>Projeto Tunes</h2>
        ...
        <h2 className={color}>Projeto Wallet</h2>
