...
function Portifolio() {
  return (
    <main id='portifolio' className='projetos-cont'>
        ...
        <h2>Projeto App de receita</h2>
        <p className='paragrafo'>Este projeto foi consumido 2 api de receitas uma de bebidas e outra de comida com parte para fazer login favoritar e finalizar receitas</p>
        ...
        <h2>Projeto Historia do android</h2>
        <p className='paragrafo'>Este projeto foi feito no curso do Gustavo guanabara no youtube</p>
        <span className='tecnologia'>Tecnologia utilizada:<br/>
        Html, Css</span><br/>
        </a>

        <a target='_blank' href='https://andre09999.github.io/Store/' rel="noreferrer"><img src={foto2} className="foto_portifolio" alt='avatar' />
        <h2>Projeto Online store</h2>
        <p className='paragrafo'>Este projeto foi consumido api do mercado livre simulando um site para compras online</p>
        <span className='tecnologia'>Tecnologia utilizada:<br/>
        Html, Css, Js, React</span><br/>
        </a>
        ...
        <h2>Projeto Starwars</h2>
        <p className='paragrafo'>Este projeto foi consumido api do starwars falando sobre os planetas do filme e com filtros para localizar melhor o que procura</p>
        <span className='tecnologia'>Tecnologia utilizada:<br/>
        Html, Css, Js, React</span><br/>
        </a>
        ...
        <p className='paragrafo'>Este projeto foi consumido api do de jogo trivia</p>
        <span className='tecnologia'>Tecnologia utilizada:<br/>
        Html, Css, Js, React</span><br/>
        </a>
        ...
        <h2>Projeto Tryunfu</h2>
        <p className='paragrafo'>Este projeto foi feito com base em jogo de tryunfu porem este e para cração de cartas</p>
        <span className='tecnologia'>Tecnologia utilizada:<br/>
        Html, Css, Js, React</span><br/>
        </a>
        ...
        <h2>Projeto Tunes</h2>
        <p className='paragrafo'>Este projeto foi feito consumindo api gratuita do itunes</p>
        <span className='tecnologia'>Tecnologia utilizada:<br/>
        Html, Css, Js, React</span><br/>
        </a>
        ...
        <p className='paragrafo'>Este projeto foi simulando uma carteira digital para monitorar os gastos fazendo soma conversão de valores</p>
        <span className='tecnologia'>Tecnologia utilizada:<br/>
        Html, Css, Js, React</span><br/>
        </a>
        </section>
